...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> hop1Neighbors = new ArrayList<Integer>() ;
		 
		 
		 List<Integer> hop2Neighbors = new ArrayList<Integer>() ;
		 
		 hop1Neighbors = getNeighbors(v) ; 
		 
		 for(int i = 0 ; i < hop1Neighbors.size() ; i++) {
			 List<Integer> immediateNeighbors = getNeighbors(hop1Neighbors.get(i)) ; 
			 for(int j = 0 ; j < immediateNeighbors.size() ; j++)
				 hop2Neighbors.add(immediateNeighbors.get(j)) ; 
		 }
